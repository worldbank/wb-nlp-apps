...
def main(model_config_id: str, cleaning_config_id: str, description: str, log_level: int):
    ...
    mallet_model = mallet_base.MalletModel(
        model_config_id=model_config_id,  # "5e26b5090bdd91d7aee4e5e89753a33b",
...
if __name__ == '__main__':
    # python -u ./scripts/models/train_mallet_base_model.py --model-config-id <model_config_id> --cleaning-config-id <cleaning_config_id> --description <description> -vv |& tee ./data/logs/train_mallet_base_model.py.log
    main()
