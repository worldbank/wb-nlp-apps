...
<html lang="en">
  <head>
    ...
    <style>
      ...
      .search-container{background:gainsboro;}
      .document-row{
        margin-top:15px;
        padding-bottom:10px;
        margin-bottom:15px;
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-custom">
      ...
      <div class="collapse navbar-collapse" id="navbarText">
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" href="http://wbes2474/nlp/topics.php" target="_blank">Topic Share Search</a>
          </li>
        </ul>
    ...
    <div class="body-container" id="app" v-cloak>
                  ...
                  <div class="row document-row" v-for="document in documents">
                    ...
                    <div class="col-md-11">
                      ...
                      <div v-show="document.id == current_document_id" class="collapse" :id="'doc-countries-'+document.id">
                        <ul v-if="Object.keys(document.metadata.countries).length > 0" style="list-style: none;">
                          ...
                          <li v-for="cdata in prepareAndSortCountries(document.metadata.countries)">
                            <table>
                              <tr>
                                <td><div class="flag" :id="cdata.country"></div></td>
                                <td><div style="margin-left: 10px;">{{cdata.country}}: {{cdata.count}} ({{cdata.proportion}}%)</div></td>
                              </tr>
                            </table>
                          </li>
                        </ul>
      ...
      <div v-if="topic_share_active || topic_map_active" class="container" style="margin-top:10px;"> -->
        ...
        <div v-show="topic_share_active && topic_share_plot_ready" class="row">
          <div v-if="topic_words" class="col-md-2" style="border-left:1px solid gainsboro;">
            <h4>Topic words</h4>
            <!--<div class="word-row" v-for="word in words">
              <div>{{word.word}}</div>
              <div>{{word.rank}}, {{word.score}}</div>
